...
html_theme_options = {
    ...
    'github_repo': 'khufu',
    'strap_line': "Twitter Bootstrap elements via Python"
}
...
""" % locals()
link_resolver_url = "https://github.com/thespacedoctor/khufu/tree/master"
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/khufu.rst']
modindex_common_prefix = ["khufu."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'khufu.tex', u'khufu Documentation',
     u'Dave Young', 'manual'),
]
